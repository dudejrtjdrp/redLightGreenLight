...
export const GameBalance = {
  ...
  score: {
     ...
     * Phase 10 튜닝(봇 시뮬 4,000라운드 × 그리드 탐색): 20 → 10.
     */
    survivorBonusK: 10,
    /**
     * 낙하 짐 1개당 술래 점수 배율(최종 정산에만 적용).
     * Phase 10 튜닝: 1.0 — "낙하 1개 = 술래 1점 = 무버 -1점" 대칭 복원.
     */
    dropPointScale: 1.0,
    /**
     * 잡기 보너스 배율.
     * Phase 10: 가속형 c(c+1)/2 → ★선형(잡기 1명당 catchBonusScale점)★으로 변경.
     * 가속형은 인원이 많을수록 술래 점수가 제곱으로 커져 인원별 밸런스를 깨는 주범
     * (시뮬로 확인). 선형 + 인원수 보정 조합이 전 구간에서 가장 공평했다.
     */
    catchBonusScale: 1.8,
     ...
     * Phase 10 재검증: 선형 잡기와 세트로 무버 2~7인 전 구간 술래 승률 44~57%.
     */
    seekerCountNorm: {
      ref: 4,
      power: 1,
