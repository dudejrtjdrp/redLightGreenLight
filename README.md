...
- **술래** = (낙하 수확 × 1 + 잡기 1명당 1.8점) × **인원수 보정 `(4/무버수)`**.
...
| **생존보너스 K** | **10** | GameBalance.score | Phase 10: 시뮬 최적화 |
| **낙하 점수 배율** | **1.0** | GameBalance.score | Phase 10: "낙하 1개=술래 1점" 대칭 |
| **잡기 보너스** | **선형 1.8/명** | GameBalance.score | Phase 10: 가속형→선형 |
...
- **결과** (Phase 10: K=10, drop=1.0, catch=선형 1.8, 보정 ON — 실제 정산 코드로 600라운드×5구간):

| 무버 수 | 술래 승률 | 플레이어 승률 | 평균 점수(술래 vs 1등) |
|---|---|---|---|
| 2 (봇1) | 52.3% | 45.8% | 8.9 vs 7.8 |
| 3 (봇2) | 45.8% | 54.2% | 8.8 vs 8.2 |
| 4 (봇3) | 43.7% | 56.3% | 8.8 vs 8.8 |
| 5 (봇4) | 41.8% | 58.0% | 8.7 vs 8.9 |
| 7 (봇6) | 53.0% | 46.8% | 9.0 vs 8.5 |
